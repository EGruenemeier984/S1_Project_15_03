...
*/
// This sets an event listner for loading the page and runs an anonymous function.
window.addEventListener("load", function () {
	// runs the calcCart function
	calcCart();
	// These elements are all updated by an event listener and run a function.
...
// This function checks if an item in the selection box is picked and if not then displays a custom validation method.
...
// This function calcCart stores the values to the session storage and changes the value based on the users inputs.
function calcCart() {
	var sesh = document.getElementById("sessionBox");
	// Stores the value of all the fields impacted by the user
...
// This function sets the content to the file from the sessionStorage and displays it on the screen.
